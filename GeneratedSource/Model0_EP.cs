...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 11:48 on jueves, 12 de octubre de 2023.
	/// </remarks>
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0 has executed. Set this to false to force re-execution of Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0</summary>
		public bool Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0_isDone;
		...
		/// <summary>True if Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11 has executed. Set this to false to force re-execution of Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11</summary>
		public bool Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isDone;
		/// <summary>True if Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11 has performed initialisation. Set this to false to force re-execution of Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11</summary>
		public bool Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isInitialised;
		/// <summary>True if Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8 has executed. Set this to false to force re-execution of Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8</summary>
		public bool Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isDone;
		/// <summary>True if Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8 has performed initialisation. Set this to false to force re-execution of Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8</summary>
		public bool Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10</summary>
		public bool Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10</summary>
		public bool Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6</summary>
		public bool Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6</summary>
		public bool Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isInitialised;
		/// <summary>True if Changed_ratingData_vint13 has executed. Set this to false to force re-execution of Changed_ratingData_vint13</summary>
		public bool Changed_ratingData_vint13_isDone;
		...
		/// <summary>True if Changed_vint13 has executed. Set this to false to force re-execution of Changed_vint13</summary>
		public bool Changed_vint13_isDone;
		...
		/// <summary>Field backing the vint13 property</summary>
		private int Vint13;
		/// <summary>Message to marginal of 'vint13'</summary>
		public PointMass<int> vint13_marginal_F;
		#endregion
		...
		public double affinityNoiseVariance
		{
			...
			set {
				if (this.AffinityNoiseVariance!=value) {
					...
					this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isInitialised = false;
					...
					this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isInitialised = false;
					...
					this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isInitialised = false;
					this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isInitialised = false;
					this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0_isDone = false;
				}
			}
		}
		...
		public Gaussian[] itemBiasPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=10)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+10)+" was expected for variable \'itemBiasPrior\'");
				}
		...
		public int[] itemData
		{
			...
			set {
				if ((value!=null)&&(value.Length!=this.Vint13)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+this.Vint13)+" was expected for variable \'itemData\'");
				}
				this.ItemData = value;
				this.numberOfIterationsDone = 0;
				...
				this.Changed_numberOfIterationsDecreased_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrio3_isInitialised = false;
				this.Changed_itemTraitsPrior_numberOfIterationsDecreased_Init_affinityNoiseVariance_itemBiasPrior_itemDat7_isInitialised = false;
				this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isDone = false;
				this.Changed_numberOfIterationsDecreased_userTraitsPrior_Init_affinityNoiseVariance_itemBiasPrior_itemDat9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isInitialised = false;
				this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isDone = false;
				this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0_isDone = false;
			}
		}
		...
		public Gaussian[][] itemTraitsPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=10)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+10)+" was expected for variable \'itemTraitsPrior\'");
				}
		...
		public bool[][] ratingData
		{
			...
			set {
				if ((value!=null)&&(value.Length!=this.Vint13)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+this.Vint13)+" was expected for variable \'ratingData\'");
				}
				this.RatingData = value;
				this.numberOfIterationsDone = 0;
				this.Changed_ratingData_vint13_isDone = false;
				this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrio3_isInitialised = false;
				this.Changed_itemTraitsPrior_numberOfIterationsDecreased_Init_affinityNoiseVariance_itemBiasPrior_itemDat7_isInitialised = false;
				this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isInitialised = false;
		...
		public Gaussian[] userBiasPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=50)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+50)+" was expected for variable \'userBiasPrior\'");
				}
		...
		public int[] userData
		{
			...
			set {
				if ((value!=null)&&(value.Length!=this.Vint13)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+this.Vint13)+" was expected for variable \'userData\'");
				}
				this.UserData = value;
				this.numberOfIterationsDone = 0;
				...
				this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_userTraitsPrior_Init_affinityNoiseVariance_itemBiasPrior_itemDat9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isDone = false;
				this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isDone = false;
				this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0_isDone = false;
			}
		}
		...
		public Gaussian[][] userThresholdsPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=50)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+50)+" was expected for variable \'userThresholdsPrior\'");
				}
		...
		public Gaussian[][] userTraitsPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=50)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+50)+" was expected for variable \'userTraitsPrior\'");
				}
		...
		/// <summary>The externally-specified value of 'vint13'</summary>
		public int vint13
		{
			get {
				return this.Vint13;
			...
			set {
				if (this.Vint13!=value) {
					this.Vint13 = value;
					this.numberOfIterationsDone = 0;
					this.Changed_ratingData_vint13_isDone = false;
					this.Changed_vint13_isDone = false;
					this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isDone = false;
					this.Changed_numberOfIterationsDecreased_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrio3_isInitialised = false;
					this.Changed_itemTraitsPrior_numberOfIterationsDecreased_Init_affinityNoiseVariance_itemBiasPrior_itemDat7_isInitialised = false;
					this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isDone = false;
					this.Changed_numberOfIterationsDecreased_userTraitsPrior_Init_affinityNoiseVariance_itemBiasPrior_itemDat9_isInitialised = false;
		...
		/// <summary>Computations that depend on the observed value of affinityNoiseVariance and itemBiasPrior and itemData and itemTraitsPrior and numberOfIterations and ratingData and thresholdsNoiseVariance and userBiasPrior and userData and userThresholdsPrior and userTraitsPrior and vint13</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0(int numberOfIterations)
		{
			if (this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0_isDone) {
				return ;
			}
			...
			userBias__0__itemuserData_observation__F = new DistributionStructArray<Gaussian,double>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			itemBias__0__itemitemData_observation__F = new DistributionStructArray<Gaussian,double>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				itemBias__0__itemitemData_observation__F[observation] = Gaussian.Uniform();
			}
			// Create array for replicates of 'bias_F'
			Gaussian[] bias_F = new Gaussian[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			userThresholds__0__itemuserData_observation__F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'userThresholds__0__itemuserData_observation_' Forwards messages.
			...
			DistributionStructArray<Gaussian,double>[] noisyThresholds_F = new DistributionStructArray<Gaussian,double>[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			Gaussian[][] noisyAffinity_rep_F = new Gaussian[this.Vint13][];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			DistributionStructArray<Gaussian,double>[] vdouble__47_F = new DistributionStructArray<Gaussian,double>[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			DistributionStructArray<Gaussian,double>[] vdouble__47_B = new DistributionStructArray<Gaussian,double>[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			Gaussian[] affinity_B = new Gaussian[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
				affinity_B[observation] = Gaussian.Uniform();
			}
			// Create array for replicates of 'productSum_B'
			Gaussian[] productSum_B = new Gaussian[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
				productSum_B[observation] = Gaussian.Uniform();
			}
			// Create array for replicates of 'products_B'
			DistributionStructArray<Gaussian,double>[] products_B = new DistributionStructArray<Gaussian,double>[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			Gaussian[] bias_B = new Gaussian[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
				bias_B[observation] = Gaussian.Uniform();
			}
			// Create array for replicates of 'noisyThresholds_use_B'
			DistributionStructArray<Gaussian,double>[] noisyThresholds_use_B = new DistributionStructArray<Gaussian,double>[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			evidence_selector_cases_0_rep6_B = new Bernoulli[this.Vint13];
			// Create array for replicates of 'evidence_selector_cases_0_rep6_rep_B'
			Bernoulli[][] evidence_selector_cases_0_rep6_rep_B = new Bernoulli[this.Vint13][];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			evidence_selector_cases_0_rep23_B = new Bernoulli[this.Vint13];
			Bernoulli[][] evidence_selector_cases_0_rep23_uses_B;
			// Create array for 'evidence_selector_cases_0_rep23_uses' Backwards messages.
			evidence_selector_cases_0_rep23_uses_B = new Bernoulli[this.Vint13][];
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'evidence_selector_cases_0_rep23_uses' Backwards messages.
			...
			Bernoulli[][] evidence_selector_cases_0_rep24_rep_B = new Bernoulli[this.Vint13][];
			Bernoulli[] evidence_selector_cases_0_rep24_B;
			// Create array for 'evidence_selector_cases_0_rep24' Backwards messages.
			evidence_selector_cases_0_rep24_B = new Bernoulli[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0_isDone = true;
		}
		...
		/// <summary>Computations that depend on the observed value of itemData and itemTraitsPrior and numberOfIterationsDecreased and userData and userTraitsPrior and vint13 and must reset on changes to affinityNoiseVariance and itemBiasPrior and ratingData and thresholdsNoiseVariance and userBiasPrior and userThresholdsPrior</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11(bool initialise)
		{
			if (this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isDone&&((!initialise)||this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isInitialised)) {
				return ;
			}
			for(int observation = 0; observation<this.Vint13; observation++) {
				for(int trait = 0; trait<2; trait++) {
			...
			this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isDone = true;
			this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of itemData and itemTraitsPrior and numberOfIterationsDecreased and vint13 and must reset on changes to affinityNoiseVariance and itemBiasPrior and ratingData and thresholdsNoiseVariance and userBiasPrior and userData and userThresholdsPrior and userTraitsPrior</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8(bool initialise)
		{
			if (this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isDone&&((!initialise)||this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isInitialised)) {
				return ;
			}
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Message to 'itemTraits__0__itemitemData_observation_' from GetItems factor
			...
			this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isDone = true;
			this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8_isInitialised = true;
		}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to affinityNoiseVariance and itemBiasPrior and itemData and itemTraitsPrior and ratingData and thresholdsNoiseVariance and userBiasPrior and userData and userThresholdsPrior and userTraitsPrior and vint13</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and userData and userTraitsPrior and vint13 and must reset on changes to affinityNoiseVariance and itemBiasPrior and itemData and itemTraitsPrior and ratingData and thresholdsNoiseVariance and userBiasPrior and userThresholdsPrior</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isInitialised)) {
				return ;
			}
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Message to 'userTraits__0__itemuserData_observation_' from GetItems factor
			...
			this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isDone = true;
			this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and userTraitsPrior and must reset on changes to affinityNoiseVariance and itemBiasPrior and itemData and itemTraitsPrior and ratingData and thresholdsNoiseVariance and userBiasPrior and userData and userThresholdsPrior and vint13</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and vint13 and must reset on changes to affinityNoiseVariance and itemBiasPrior and itemData and itemTraitsPrior and ratingData and thresholdsNoiseVariance and userBiasPrior and userData and userThresholdsPrior and userTraitsPrior</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isInitialised)) {
				return ;
			}
			for(int observation = 0; observation<this.Vint13; observation++) {
				for(int trait = 0; trait<2; trait++) {
			...
			this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isDone = true;
			this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of ratingData and vint13</summary>
		private void Changed_ratingData_vint13()
		{
			if (this.Changed_ratingData_vint13_isDone) {
				return ;
			}
			// Create array for 'ratingData_marginal' Forwards messages.
			this.ratingData_marginal_F = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'ratingData_marginal' Forwards messages.
			...
			this.Changed_ratingData_vint13_isDone = true;
		}
		...
		/// <summary>Computations that depend on the observed value of vint13</summary>
		private void Changed_vint13()
		{
			if (this.Changed_vint13_isDone) {
				return ;
			}
			// Create array for 'itemTraits__0__itemitemData_observation_' Forwards messages.
			this.itemTraits__0__itemitemData_observation__F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'itemTraits__0__itemitemData_observation_' Forwards messages.
			...
			this.itemTraits__0__itemitemData_observation__B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'itemTraits__0__itemitemData_observation_' Backwards messages.
			...
			this.products_F = new DistributionStructArray<Gaussian,double>[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
			...
			this.userTraits__0__itemuserData_observation__B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'userTraits__0__itemuserData_observation_' Backwards messages.
			...
			this.userTraits__0__itemuserData_observation__F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'userTraits__0__itemuserData_observation_' Forwards messages.
			...
			this.userBias__0__itemuserData_observation__B = new DistributionStructArray<Gaussian,double>(this.Vint13);
			// Create array for 'itemBias__0__itemitemData_observation_' Backwards messages.
			this.itemBias__0__itemitemData_observation__B = new DistributionStructArray<Gaussian,double>(this.Vint13);
			// Create array for 'userThresholds__0__itemuserData_observation_' Backwards messages.
			this.userThresholds__0__itemuserData_observation__B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.Vint13);
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'userThresholds__0__itemuserData_observation_' Backwards messages.
			...
			this.noisyAffinity_F = new Gaussian[this.Vint13];
			for(int observation = 0; observation<this.Vint13; observation++) {
				this.noisyAffinity_F[observation] = Gaussian.Uniform();
			}
			// Create array for replicates of 'noisyAffinity_rep_B_toDef'
			this.noisyAffinity_rep_B_toDef = new Gaussian[this.Vint13];
			// Create array for replicates of 'noisyAffinity_rep_B'
			this.noisyAffinity_rep_B = new Gaussian[this.Vint13][];
			for(int observation = 0; observation<this.Vint13; observation++) {
				// Create array for 'noisyAffinity_rep' Backwards messages.
				this.noisyAffinity_rep_B[observation] = new Gaussian[2];
			}
			this.vint13_marginal_F = new PointMass<int>(this.Vint13);
			// Message to 'vint13_marginal' from DerivedVariable factor
			this.vint13_marginal_F = DerivedVariableOp.MarginalAverageConditional<PointMass<int>,int>(this.Vint13, this.vint13_marginal_F);
			this.Changed_vint13_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_ratingData_vint13();
			...
			this.Constant();
			this.Changed_vint13();
			this.Changed_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemBiasPrior_itemData_itemTra6(initialise);
			...
			this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_vint13_Init_affinityNoiseVariance_itemB8(initialise);
			...
			this.Changed_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_affinityNoiseVariance_itemB10(initialise);
			this.Changed_itemData_itemTraitsPrior_numberOfIterationsDecreased_userData_userTraitsPrior_vint13_Init_af11(initialise);
			this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numberOfIterations_ratingData_t0(numberOfIterations);
		...
		/// <summary>
		/// Returns the marginal distribution for 'vint13' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<int> Vint13Marginal()
		{
			return this.vint13_marginal_F;
		}
