...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 17:31 on miércoles, 4 de octubre de 2023.
	/// </remarks>
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0()
		{
			...
			userTraits_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(200);
			...
			itemTraits_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(200);
			...
			userBias_F = new DistributionStructArray<Gaussian,double>(200);
			for(int user = 0; user<200; user++) {
