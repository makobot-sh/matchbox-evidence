...
namespace Models
{
	...
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0 has executed. Set this to false to force re-execution of Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0</summary>
		public bool Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0_isDone;
		...
		public double affinityNoiseVariance
		{
			...
			set {
				if (this.AffinityNoiseVariance!=value) {
					...
					this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0_isDone = false;
				}
			}
		}
		...
		/// <summary>Computations that depend on the observed value of affinityNoiseVariance and itemBiasPrior and itemData and itemTraitsPrior and numObservations and thresholdsNoiseVariance and userBiasPrior and userData and userThresholdsPrior and userTraitsPrior</summary>
		private void Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0()
		{
			if (this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0_isDone) {
				return ;
			}
			...
			evidence_selector_cases_0_uses_B = new Bernoulli[53];
			...
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> userTraits_F;
			// Create array for 'userTraits' Forwards messages.
			userTraits_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(50);
			for(int user = 0; user<50; user++) {
				// Create array for 'userTraits' Forwards messages.
				userTraits_F[user] = new DistributionStructArray<Gaussian,double>(2);
				for(int trait = 0; trait<2; trait++) {
					userTraits_F[user][trait] = Gaussian.Uniform();
				}
			}
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> userTraits_use_F_marginal;
			userTraits_use_F_marginal = GetItemsOp<double[]>.MarginalInit<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>>(userTraits_F);
			for(int user = 0; user<50; user++) {
				for(int trait = 0; trait<2; trait++) {
					// Message to 'userTraits' from Random factor
					userTraits_F[user][trait] = ArrayHelper.SetTo<Gaussian>(userTraits_F[user][trait], this.UserTraitsPrior[user][trait]);
				}
			}
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> userTraits_itemuserData_observation__B;
			// Create array for 'userTraits_itemuserData_observation_' Backwards messages.
			userTraits_itemuserData_observation__B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.NumObservations);
			for(int observation = 0; observation<this.NumObservations; observation++) {
				// Create array for 'userTraits_itemuserData_observation_' Backwards messages.
				userTraits_itemuserData_observation__B[observation] = new DistributionStructArray<Gaussian,double>(2);
				for(int trait = 0; trait<2; trait++) {
					userTraits_itemuserData_observation__B[observation][trait] = Gaussian.Uniform();
				}
			}
			...
			userTraits_use_F_marginal = GetItemsOp<double[]>.Marginal<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(userTraits_F, userTraits_use_B, userTraits_use_F_marginal);
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> userTraits_itemuserData_observation__F;
			// Create array for 'userTraits_itemuserData_observation_' Forwards messages.
			userTraits_itemuserData_observation__F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.NumObservations);
			for(int observation = 0; observation<this.NumObservations; observation++) {
				// Create array for 'userTraits_itemuserData_observation_' Forwards messages.
				userTraits_itemuserData_observation__F[observation] = new DistributionStructArray<Gaussian,double>(2);
				for(int trait = 0; trait<2; trait++) {
					userTraits_itemuserData_observation__F[observation][trait] = Gaussian.Uniform();
				}
				// Message to 'userTraits_itemuserData_observation_' from GetItems factor
				userTraits_itemuserData_observation__F[observation] = GetItemsOp<double[]>.ItemsAverageConditional<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(userTraits_itemuserData_observation__B[observation], userTraits_F, userTraits_use_F_marginal, this.UserData, observation, userTraits_itemuserData_observation__F[observation]);
			}
			evidence_selector_cases_0_uses_B[27] = Bernoulli.Uniform();
			// Message to 'evidence_selector_cases_0_uses' from GetItems factor
			evidence_selector_cases_0_uses_B[27] = Bernoulli.FromLogOdds(GetItemsOp<double[]>.LogEvidenceRatio<DistributionStructArray<Gaussian,double>>(userTraits_itemuserData_observation__B, userTraits_F, this.UserData, userTraits_itemuserData_observation__F));
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> itemTraits_F;
			// Create array for 'itemTraits' Forwards messages.
			itemTraits_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(10);
			for(int item = 0; item<10; item++) {
				// Create array for 'itemTraits' Forwards messages.
				itemTraits_F[item] = new DistributionStructArray<Gaussian,double>(2);
			}
			for(int trait = 0; trait<2; trait++) {
				for(int item = 0; item<10; item++) {
					itemTraits_F[item][trait] = Gaussian.Uniform();
				}
			}
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> itemTraits_use_F_marginal;
			itemTraits_use_F_marginal = GetItemsOp<double[]>.MarginalInit<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>>(itemTraits_F);
			for(int trait = 0; trait<2; trait++) {
				for(int item = 0; item<10; item++) {
					// Message to 'itemTraits' from Random factor
					itemTraits_F[item][trait] = ArrayHelper.SetTo<Gaussian>(itemTraits_F[item][trait], this.ItemTraitsPrior[item][trait]);
				}
			}
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> itemTraits_itemitemData_observation__B;
			// Create array for 'itemTraits_itemitemData_observation_' Backwards messages.
			itemTraits_itemitemData_observation__B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.NumObservations);
			for(int observation = 0; observation<this.NumObservations; observation++) {
				// Create array for 'itemTraits_itemitemData_observation_' Backwards messages.
				itemTraits_itemitemData_observation__B[observation] = new DistributionStructArray<Gaussian,double>(2);
				for(int trait = 0; trait<2; trait++) {
					itemTraits_itemitemData_observation__B[observation][trait] = Gaussian.Uniform();
				}
			}
			...
			itemTraits_use_F_marginal = GetItemsOp<double[]>.Marginal<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(itemTraits_F, itemTraits_use_B, itemTraits_use_F_marginal);
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> itemTraits_itemitemData_observation__F;
			// Create array for 'itemTraits_itemitemData_observation_' Forwards messages.
			itemTraits_itemitemData_observation__F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.NumObservations);
			for(int observation = 0; observation<this.NumObservations; observation++) {
				// Create array for 'itemTraits_itemitemData_observation_' Forwards messages.
				itemTraits_itemitemData_observation__F[observation] = new DistributionStructArray<Gaussian,double>(2);
				for(int trait = 0; trait<2; trait++) {
					itemTraits_itemitemData_observation__F[observation][trait] = Gaussian.Uniform();
				}
				// Message to 'itemTraits_itemitemData_observation_' from GetItems factor
				itemTraits_itemitemData_observation__F[observation] = GetItemsOp<double[]>.ItemsAverageConditional<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(itemTraits_itemitemData_observation__B[observation], itemTraits_F, itemTraits_use_F_marginal, this.ItemData, observation, itemTraits_itemitemData_observation__F[observation]);
			}
			evidence_selector_cases_0_uses_B[29] = Bernoulli.Uniform();
			// Message to 'evidence_selector_cases_0_uses' from GetItems factor
			evidence_selector_cases_0_uses_B[29] = Bernoulli.FromLogOdds(GetItemsOp<double[]>.LogEvidenceRatio<DistributionStructArray<Gaussian,double>>(itemTraits_itemitemData_observation__B, itemTraits_F, this.ItemData, itemTraits_itemitemData_observation__F));
			DistributionStructArray<Gaussian,double> userBias_itemuserData_observation__B;
			// Create array for 'userBias_itemuserData_observation_' Backwards messages.
			userBias_itemuserData_observation__B = new DistributionStructArray<Gaussian,double>(this.NumObservations);
			for(int observation = 0; observation<this.NumObservations; observation++) {
				userBias_itemuserData_observation__B[observation] = Gaussian.Uniform();
			}
			...
			userBias_use_F_marginal = GetItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(this.UserBiasPrior, userBias_use_B, userBias_use_F_marginal);
			...
			for(int observation = 0; observation<this.NumObservations; observation++) {
				...
				userBias_itemuserData_observation__F[observation] = GetItemsOp<double>.ItemsAverageConditional<DistributionStructArray<Gaussian,double>,Gaussian>(userBias_itemuserData_observation__B[observation], userBias_F, userBias_use_F_marginal, this.UserData, observation, userBias_itemuserData_observation__F[observation]);
			}
			evidence_selector_cases_0_uses_B[33] = Bernoulli.Uniform();
			// Message to 'evidence_selector_cases_0_uses' from GetItems factor
			evidence_selector_cases_0_uses_B[33] = Bernoulli.FromLogOdds(GetItemsOp<double>.LogEvidenceRatio<Gaussian>(userBias_itemuserData_observation__B, this.UserBiasPrior, this.UserData, userBias_itemuserData_observation__F));
			DistributionStructArray<Gaussian,double> itemBias_itemitemData_observation__B;
			// Create array for 'itemBias_itemitemData_observation_' Backwards messages.
			itemBias_itemitemData_observation__B = new DistributionStructArray<Gaussian,double>(this.NumObservations);
			for(int observation = 0; observation<this.NumObservations; observation++) {
				itemBias_itemitemData_observation__B[observation] = Gaussian.Uniform();
			}
			...
			itemBias_use_F_marginal = GetItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(this.ItemBiasPrior, itemBias_use_B, itemBias_use_F_marginal);
			...
			for(int observation = 0; observation<this.NumObservations; observation++) {
				...
				itemBias_itemitemData_observation__F[observation] = GetItemsOp<double>.ItemsAverageConditional<DistributionStructArray<Gaussian,double>,Gaussian>(itemBias_itemitemData_observation__B[observation], itemBias_F, itemBias_use_F_marginal, this.ItemData, observation, itemBias_itemitemData_observation__F[observation]);
			}
			evidence_selector_cases_0_uses_B[35] = Bernoulli.Uniform();
			// Message to 'evidence_selector_cases_0_uses' from GetItems factor
			evidence_selector_cases_0_uses_B[35] = Bernoulli.FromLogOdds(GetItemsOp<double>.LogEvidenceRatio<Gaussian>(itemBias_itemitemData_observation__B, this.ItemBiasPrior, this.ItemData, itemBias_itemitemData_observation__F));
			...
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> userThresholds_itemuserData_observation__B;
			// Create array for 'userThresholds_itemuserData_observation_' Backwards messages.
			userThresholds_itemuserData_observation__B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.NumObservations);
			for(int observation = 0; observation<this.NumObservations; observation++) {
				// Create array for 'userThresholds_itemuserData_observation_' Backwards messages.
				userThresholds_itemuserData_observation__B[observation] = new DistributionStructArray<Gaussian,double>(2);
				for(int level = 0; level<2; level++) {
					userThresholds_itemuserData_observation__B[observation][level] = Gaussian.Uniform();
				}
			}
			...
			userThresholds_use_F_marginal = GetItemsOp<double[]>.Marginal<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(userThresholds_F, userThresholds_use_B, userThresholds_use_F_marginal);
			...
			for(int observation = 0; observation<this.NumObservations; observation++) {
				...
				userThresholds_itemuserData_observation__F[observation] = GetItemsOp<double[]>.ItemsAverageConditional<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(userThresholds_itemuserData_observation__B[observation], userThresholds_F, userThresholds_use_F_marginal, this.UserData, observation, userThresholds_itemuserData_observation__F[observation]);
			}
			evidence_selector_cases_0_uses_B[45] = Bernoulli.Uniform();
			// Message to 'evidence_selector_cases_0_uses' from GetItems factor
			evidence_selector_cases_0_uses_B[45] = Bernoulli.FromLogOdds(GetItemsOp<double[]>.LogEvidenceRatio<DistributionStructArray<Gaussian,double>>(userThresholds_itemuserData_observation__B, userThresholds_F, this.UserData, userThresholds_itemuserData_observation__F));
			...
			DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]> ratingData_F;
			// Create array for 'ratingData' Forwards messages.
			ratingData_F = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(this.NumObservations);
			...
			Gaussian[][] noisyAffinity_rep_B = new Gaussian[this.NumObservations][];
			...
			DistributionStructArray<Gaussian,double>[] products_F = new DistributionStructArray<Gaussian,double>[this.NumObservations];
			...
			Gaussian[] noisyAffinity_F = new Gaussian[this.NumObservations];
			...
			Gaussian[] noisyAffinity_rep_B_toDef = new Gaussian[this.NumObservations];
			...
			Bernoulli ratingData_use_B_reduced;
			ratingData_use_B_reduced = default(Bernoulli);
			if (this.NumObservations>0) {
				ratingData_use_B_reduced = Bernoulli.Uniform();
			}
			for(int observation = 0; observation<this.NumObservations; observation++) {
				// Create array for 'ratingData' Forwards messages.
				ratingData_F[observation] = new DistributionStructArray<Bernoulli,bool>(2);
				...
				noisyAffinity_rep_B[observation] = new Gaussian[2];
				// Create array for 'noisyAffinity_rep' Forwards messages.
				noisyAffinity_rep_F[observation] = new Gaussian[2];
				noisyAffinity_F[observation] = Gaussian.Uniform();
				noisyAffinity_rep_F_marginal[observation] = ReplicateOp_Divide.MarginalInit<Gaussian>(noisyAffinity_F[observation]);
				...
				products_F[observation] = new DistributionStructArray<Gaussian,double>(2);
				for(int trait = 0; trait<2; trait++) {
					products_F[observation][trait] = Gaussian.Uniform();
					// Message to 'products' from Product factor
					products_F[observation][trait] = GaussianProductOp_SHG09.ProductAverageConditional(userTraits_itemuserData_observation__F[observation][trait], itemTraits_itemitemData_observation__F[observation][trait], userTraits_itemuserData_observation__B[observation][trait], itemTraits_itemitemData_observation__B[observation][trait]);
				}
				// Message to 'productSum' from Sum factor
				productSum_F[observation] = FastSumOp.SumAverageConditional(products_F[observation]);
				...
				noisyAffinity_F[observation] = GaussianFromMeanAndVarianceOp.SampleAverageConditional(affinity_F[observation], this.AffinityNoiseVariance);
				noisyAffinity_rep_B_toDef[observation] = ReplicateOp_Divide.ToDefInit<Gaussian>(noisyAffinity_F[observation]);
				noisyAffinity_rep_F_marginal[observation] = ReplicateOp_Divide.Marginal<Gaussian>(noisyAffinity_rep_B_toDef[observation], noisyAffinity_F[observation], noisyAffinity_rep_F_marginal[observation]);
				// Create array for 'ratingData_marginal' Forwards messages.
				this.ratingData_marginal_F[observation] = new DistributionStructArray<Bernoulli,bool>(2);
				for(int level = 0; level<2; level++) {
					ratingData_F[observation][level] = Bernoulli.Uniform();
					...
					noisyAffinity_rep_B[observation][level] = Gaussian.Uniform();
					noisyAffinity_rep_F[observation][level] = Gaussian.Uniform();
					// Message to 'noisyAffinity_rep' from Replicate factor
					noisyAffinity_rep_F[observation][level] = ReplicateOp_Divide.UsesAverageConditional<Gaussian>(noisyAffinity_rep_B[observation][level], noisyAffinity_rep_F_marginal[observation], level, noisyAffinity_rep_F[observation][level]);
					...
					// Message to 'ratingData' from IsPositive factor
					ratingData_F[observation][level] = IsPositiveOp.IsPositiveAverageConditional(vdouble__23_F[observation][level]);
					// Message to 'ratingData_marginal' from DerivedVariable factor
					this.ratingData_marginal_F[observation][level] = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(ratingData_use_B_reduced, ratingData_F[observation][level], this.ratingData_marginal_F[observation][level]);
				}
			}
			this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_affinityNoiseVariance_itemBiasPrior_itemData_itemTraitsPrior_numObservations_thresholdsNoise0();
