...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 14:07 on sábado, 7 de octubre de 2023.
	/// </remarks>
	public partial class Model2_EP : IGeneratedAlgorithm
	{
		...
		public Gaussian[][] vGaussian____10
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vGaussian____10\'");
				}
		...
		public Gaussian[][] vGaussian____11
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vGaussian____11\'");
				}
		...
		public Gaussian[][] vGaussian____9
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vGaussian____9\'");
				}
		...
		public Gaussian[] vGaussian__26
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vGaussian__26\'");
				}
		...
		public Gaussian[] vGaussian__27
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vGaussian__27\'");
				}
		...
		private void Changed_itemData_numberOfIterations_ratingData_userData_vGaussian____10_vGaussian____11_vGaussian___0(int numberOfIterations)
		{
			...
			evidence_selector_uses_F_marginal = ReplicateOp_Divide.MarginalInit<Bernoulli>(vBernoulli2);
			Bernoulli evidence_selector_uses_B_toDef;
			evidence_selector_uses_B_toDef = ReplicateOp_Divide.ToDefInit<Bernoulli>(vBernoulli2);
			...
			for(int index16 = 0; index16<200; index16++) {
			...
			evidence_selector_uses_F_marginal = ReplicateOp_Divide.Marginal<Bernoulli>(evidence_selector_uses_B_toDef, vBernoulli2, evidence_selector_uses_F_marginal);
			...
			this.evidence_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(evidence_selector_uses_B_toDef, vBernoulli2, this.evidence_marginal_F);
