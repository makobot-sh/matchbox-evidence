...
namespace Models
{
	...
	public partial class Model1_EP : IGeneratedAlgorithm
	{
		...
		public Gaussian[][] vGaussian____6
		{
			...
			set {
				if ((value!=null)&&(value.Length!=50)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+50)+" was expected for variable \'vGaussian____6\'");
				}
		...
		public Gaussian[][] vGaussian____7
		{
			...
			set {
				if ((value!=null)&&(value.Length!=10)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+10)+" was expected for variable \'vGaussian____7\'");
				}
		...
		public Gaussian[][] vGaussian____8
		{
			...
			set {
				if ((value!=null)&&(value.Length!=50)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+50)+" was expected for variable \'vGaussian____8\'");
				}
		...
		public Gaussian[] vGaussian__18
		{
			...
			set {
				if ((value!=null)&&(value.Length!=50)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+50)+" was expected for variable \'vGaussian__18\'");
				}
		...
		public Gaussian[] vGaussian__19
		{
			...
			set {
				if ((value!=null)&&(value.Length!=10)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+10)+" was expected for variable \'vGaussian__19\'");
				}
